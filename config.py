...
CHARACTERS = {
    ...
    "usiel": {"name":"Usiel","desc":"Admin Recursos - Regen","color":(255,200,50),"hp":150,"max_hp":150,"stamina":140,"speed":2.8,"ability":"bolillo","cd":30000,"dmg":10,"fr":160,"mag":30,"shots":1,"reserve":250,"reload":1000,"spr":0.04,"passive":"lifesteal+0.03"},
    ...
    "eder": {"name":"Eder","desc":"Tornado Láser - Fusión","color":(255,80,80),"hp":100,"max_hp":100,"stamina":90,"speed":3.0,"ability":"tornado_laser","cd":25000,"dmg":18,"fr":180,"mag":25,"shots":1,"reserve":180,"reload":1200,"spr":0.03,"passive":"firerate*0.95"},
...
DOMAIN_EXPANSION = {
    ...
    "eder":   {"name":"Ojo del Tornado",      "color":(255,80,80), "effect":"tornado"},
...
OSCAR_ITEMS = [
    ...
    {"name":"Admin Persistente (Usiel)","desc":"-10% CD habilidades", "cost":1500, "type":"unique_usiel"},
    {"name":"Fan (Obed)","desc":"Billie dura el doble", "cost":1500, "type":"unique_obed"},
    {"name":"Laser Cargado (Eder)","desc":"+50% dmg laser", "cost":1500, "type":"unique_eder"},
